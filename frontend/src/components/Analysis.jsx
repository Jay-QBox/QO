...
export default function Analysis() {
  ...
  const sidebarOptions = [
    ...
    { id: 2, label: 'Operational Analysis' },
    { id: 3, label: 'Financial Analysis' },
    { id: 4, label: 'Technical Analysis' },
    { id: 5, label: 'Compliance Analysis' },
    { id: 6, label: 'Competitor Analysis' },
    { id: 7, label: 'Geo Analysis' },
  ];
  const countryLevel = [
    {
      id: 0,
