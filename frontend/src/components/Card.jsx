...
export default function Card({ title, description, imageUrl,bullet, onReadMore }) {
  return (
    <div onClick={onReadMore}  className="cursor-pointer relative flex flex-col my-6 bg-white shadow-sm justify-between border border-slate-200 rounded-lg w-96 hover:shadow-lg bg-black-500">
