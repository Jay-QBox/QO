...
export default function Revenue() {
  ...
  const sidebarOptions = [
    { id: 1, label: 'Revenues Derivation' },
    { id: 2, label: 'Forecasted Revenues - 6 & 12 months' },
    { id: 3, label: 'ROI Calculation' },
    { id: 4, label: 'Company Valuation ' },
    { id: 5, label: 'Investment Ask' },
  ];
  const countryLevel = [
    {
      id: 0,
